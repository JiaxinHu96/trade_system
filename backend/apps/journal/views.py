...
class PreTradePlanViewSet(viewsets.ModelViewSet):
    ...
    def assist(self, request):
        ...
        return Response({
            ...
            'universe_scope': 'imported_executions_only',
            'can_fetch_full_exchange_universe': False,
            'full_universe_note': 'Current catalog is based on imported IBKR executions only, not full exchange instrument master.',
